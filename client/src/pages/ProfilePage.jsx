        ...
        <div className="bg-base-300 rounded-xl p-6 space-y-8">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              <img
                src={picPreview || authUser?.data?.profilePic || "/avatar.png"}
            ...
            <button
              ...
              className={`p-3 ${picPreview?'bg-green-500':'bg-gray-700 '} rounded-lg text-white ${
                picFile ? "cursor-pointer" : "opacity-50 cursor-not-allowed"
              }`}
              disabled={!picFile || updatingProfile}
            >
